<?php
$recommendation_header = get_field('recommendation_header', get_the_ID());
$recommendations = get_field('recommendations', get_the_ID());
?>
...
<?php if (!empty($recommendations)) : ?>
	<section  data-aos-delay="100"  data-aos="fade-up" class="recommendations-  my-4 relative pb-8" >
		<div class="container mx-auto p-12  lg:px-24 2xl:px-16  ">
			<?php if (!empty($recommendation_header)): ?>
				<h2 class="font-barlow text-3xl lg:text-4xl font-bold text-black mb-8 text-center"><?php echo wp_kses_post($recommendation_header); ?></h2>
			<?php endif; ?>
		<div class="recommendations-swiper   ">
			<div class="swiper-wrapper ">
				<?php foreach ($recommendations as $item) : ?>
					<div class="swiper-slide">
						<div class="p-4 bg-white shadow-lg rounded-lg text-left h-full">
							<!-- Name and Date -->
							<div class="top flex  justify-between">
								<div>
							<?php if (!empty($item['name'])) : ?>
								<h3 class="text-xl font-bold"><?php echo esc_html($item['name']); ?></h3>
							<?php endif; ?>
							<?php if (!empty($item['company'])) : ?>
								<p class="text-sm text-gray-500 mb-2"><?php echo esc_html($item['company']); ?></p>
							<?php endif; ?>
								</div>
							<!-- Google Logo -->
