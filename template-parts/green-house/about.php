...
<section class="o-inwestycji flex flex-col lg:flex-row" id="o-inwestycji">
    <div class="col-5">
        ...
        <button class="btn" onclick="window.location.href='<?php echo esc_url(get_field('about_button_url') ?: '#mieszkania'); ?>'" aria-label="<?php echo esc_attr(get_field('about_button_text') ?: 'Zobacz mieszkania'); ?> - <?php echo esc_attr(get_field('about_title') ?: 'O inwestycji'); ?>">
            <?php echo esc_html(get_field('about_button_text') ?: 'Zobacz mieszkania'); ?>
        </button>
    </div>
