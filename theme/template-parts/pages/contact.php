...
<section class="contact-block_dotted__arrow-bottom-right" data-aos="fade-up" data-aos-duration="1000">
	<div class="container flex-col font-barlow lg:flex-row mx-auto p-12 lg:px-24 2xl:px-16 flex dots__overlay-center mb-4 contact__container font-barlow">
		<div class="contact__info w-full lg:w-6/12 " data-aos="fade-right" data-aos-duration="1000">
			<div class="text-center md:text-left grid">
				<?php if (!empty($contact_section)) : ?>
					...
					<div class="flex items-center flex-col justify-center mb-4 p-16 gap-8" data-aos="zoom-in" data-aos-delay="200">
						...
						<i class="fas fa-phone-alt mr-2 text-md text-black"></i>
					...
					<div class="flex items-center flex-col justify-center p-8 gap-4" data-aos="zoom-in" data-aos-delay="400">
						...
						<i class="fas fa-paper-plane mr-2 text-md text-black"></i>
						<span class="font-500 text-lg">Wyślij e-mail</span>
						<?php if (!empty($contact_section['e-mail'])) : ?>
							<a href="mailto:<?php echo esc_attr($contact_section['e-mail']); ?>" class="btn--dark font-bold text-black rounded-lg">
