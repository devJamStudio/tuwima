<?php
/**
 * CertExpert functions and definitions
 *
...
if ( ! function_exists( 'future_setup' ) ) :
	...
	function future_setup() {
		 ...
		 * If you're building a theme based on CertExpert, use a find and replace
...
function future_scripts() {
	...
	wp_enqueue_style( 'future-scss', get_template_directory_uri() . '/build/css/theme/scss/style.css', array(), FUTURE_VERSION );
	wp_enqueue_style( 'future-map-style', get_template_directory_uri() . '/inc/cssMap/cssmap-poland/cssmap-poland.css', array(), FUTURE_VERSION );
	wp_enqueue_script( 'future-jquery-map', get_template_directory_uri() . '/js/jquery-map.js', array('jquery'), FUTURE_VERSION, true );
	wp_enqueue_script( 'future-jquery', get_template_directory_uri() . '/js/jquery.js', array('jquery'), FUTURE_VERSION, true );

	wp_enqueue_script( 'future-script', get_template_directory_uri() . '/js/script.min.js', array(), FUTURE_VERSION, true );
	wp_enqueue_script( 'future-map-script', get_template_directory_uri() . '/inc/cssMap/jquery.cssmap.min.js', array(), FUTURE_VERSION, true );
...
function future_enqueue_block_editor_script() {
	if ( is_admin() ) {
		...
		wp_enqueue_style('future-editor',
